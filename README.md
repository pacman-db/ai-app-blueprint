...
Deja de re-explicarle tu proyecto a Claude en cada sesión.
...
- **GitHub Spec-Kit** — specs before code, constitution, clarify, plan. *Here:* Claude generates them from your idea instead of you writing them by hand.
